...
(defhydra ej/gptel-helper (:foreign-keys warn :exit nil :quit-key "q" :columns 1)
  "gptel"
  ("a" gptel-add "gptel-add" :exit t)
  ("r" gptel-rewrite "gptel-rewrite" :exit t)

  ("e" er/expand-region "expand")
  ("M-s-p" er/expand-region "expand")
  ("w" kill-ring-save "kill-ring-save" :exit t)
  ("b" ej/git-browse "git-browse" :exit t)
  ("!" (gptel-context-remove-all nil) "gptel-context-remove-all" :exit t)
  )
(global-set-key (kbd "M-s-p") 'ej/gptel-helper/body)
